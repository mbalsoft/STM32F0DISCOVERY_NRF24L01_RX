...
uint8_t tm2_NRF24L01_Init( NRF24L01_config_TypeDef *nrf_config ) {
	...
	tm2_NRF24L01_WriteRegister( nrf_config, NRF24L01_REG_DYNPD, (0 << NRF24L01_DPL_P0) | (0 << NRF24L01_DPL_P1) | (0 << NRF24L01_DPL_P2) | (0 << NRF24L01_DPL_P3) | (0 << NRF24L01_DPL_P4) | (0 << NRF24L01_DPL_P5));
...
void tm2_NRF24L01_SetRF( NRF24L01_config_TypeDef *nrf_config ) {
	uint8_t tmp = 0;
